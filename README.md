...
:brain: [Understanding OAuth 2.0](https://www.passportjs.org/concepts/oauth2/?utm_source=github&utm_medium=referral&utm_campaign=passport-google-oauth3&utm_content=nav-concept) •
:heart: [Sponsors](https://www.passportjs.org/sponsors/?utm_source=github&utm_medium=referral&utm_campaign=passport-google-oauth3&utm_content=nav-sponsors)
...
```sh
$ npm install passport-google-oauth3
```

###### TypeScript type declarations

```sh
$ npm install @types/passport-google-oauth3
```
...
```js
var GoogleStrategy = require('passport-google-oauth3');
